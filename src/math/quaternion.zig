...
pub fn Quaternion(comptime T: type) type {
    ...
    return extern struct {
        ...
        pub fn fromAxis(degrees: T, axis: Vector3) Self {
            const radians = util.toRadians(degrees);
        ...
        pub fn extractEulerAngles(self: Self) Vector3 {
            ...
            return Vector3.new(util.toDegrees(yaw), util.toDegrees(pitch), util.toDegrees(roll));
        }
        ...
        pub fn extractAxisAngle(self: Self) struct { axis: Vector3, angle: T } {
            ...
            return .{
                .axis = res_axis,
                .angle = util.toDegrees(res_angle),
            };
        }
        ...
        pub fn lerp(left: Self, right: Self, t: T) Self {
            const w = util.lerp(T, left.w, right.w, t);
            const x = util.lerp(T, left.x, right.x, t);
            const y = util.lerp(T, left.y, right.y, t);
            const z = util.lerp(T, left.z, right.z, t);
            return Self.new(w, x, y, z);
        }
