...
pub fn Mat4x4(comptime T: type) type {
    ...
    return extern struct {
        ...
        pub fn fromRotation(angle_in_degrees: T, axis: Vector3) Self {
            ...
            const sin_theta = @sin(util.toRadians(angle_in_degrees));
            const cos_theta = @cos(util.toRadians(angle_in_degrees));
        ...
        pub fn extractEulerAngles(self: Self) Vector3 {
            ...
            return Vector3.new(util.toDegrees(theta_x), util.toDegrees(theta_y), util.toDegrees(theta_z));
        }
        ...
        pub fn perspective(fovy_in_degrees: T, aspect_ratio: T, z_near: T, z_far: T) Self {
            ...
            const f = 1 / @tan(util.toRadians(fovy_in_degrees) * 0.5);
