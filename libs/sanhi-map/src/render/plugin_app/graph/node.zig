...
const RenderContext = @import("../renderer/context.zig").RenderContext;
...
pub const Node = struct {
    ...
    pub fn run(self: *Self, ctx: *RenderGraphContext, renderContext: *RenderContext) NodeRunError!void {
        return self.vtable.run(self.ptr, ctx, renderContext);
    }
...
pub const EmptyNode = struct {
    ...
    pub fn run(_: *anyopaque, _: *graph.RenderGraphContext, _: *RenderContext) graph.NodeRunError!void {}
