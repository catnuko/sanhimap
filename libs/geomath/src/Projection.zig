...
pub const Projection = struct {
    ...
    pub const VTable = struct {
        ...
        project: *const fn (ctx: *anyopaque, geoPoint: *const Cartographic) Vec3,
        unproject: *const fn (ctx: *anyopaque, worldPoint: * const Vec3) Cartographic,
        unprojectAltitude: *const fn (ctx: *anyopaque, worldPoint: * const Vec3) f64,
        groundDistance: *const fn (ctx: *anyopaque, worldPoint: * const Vec3) f64,
        scalePointToSurface: *const fn (ctx: *anyopaque, worldPoint: * const Vec3) Vec3,
        localTagentSpace: *const fn (ctx: *anyopaque, geoPoint: *const Cartographic) Mat4,
    };
    ptr: *anyopaque,
    vtable: *const VTable,
    pub fn new(ptr: anytype) Projection {
        ...
        const gen = struct {
            ...
            pub fn project(ctx: *anyopaque, geoPoint: *const Cartographic) Vec3 {
                const self: T = @ptrCast(@alignCast(ctx));
                return ptr_info.Pointer.child.project(self, geoPoint);
            }
            pub fn unproject(ctx: *anyopaque, worldPoint: * const Vec3) Cartographic {
                const self: T = @ptrCast(@alignCast(ctx));
                return ptr_info.Pointer.child.unproject(self, worldPoint);
            }
            pub fn unprojectAltitude(ctx: *anyopaque, worldPoint: * const Vec3) f64 {
                const self: T = @ptrCast(@alignCast(ctx));
                return ptr_info.Pointer.child.unprojectAltitude(self, worldPoint);
            }
            pub fn groundDistance(ctx: *anyopaque, worldPoint: * const Vec3) f64 {
                const self: T = @ptrCast(@alignCast(ctx));
                return ptr_info.Pointer.child.groundDistance(self, worldPoint);
            }
            pub fn scalePointToSurface(ctx: *anyopaque, worldPoint: * const Vec3) Vec3 {
                const self: T = @ptrCast(@alignCast(ctx));
                return ptr_info.Pointer.child.scalePointToSurface(self, worldPoint);
            }
            pub fn localTagentSpace(ctx: *anyopaque, geoPoint: *const Cartographic) Mat4 {
                const self: T = @ptrCast(@alignCast(ctx));
    ...
    pub fn localTagentSpace(this: This, geoPoint: *const Cartographic) Mat4 {
